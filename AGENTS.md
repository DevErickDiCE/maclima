...
2. **Uso de Registros**: Lee primero `docs/seo/calendario-publicaciones.csv` y `docs/seo/registro-publicaciones.csv` para comprobar títulos, slugs, descripciones, palabras clave principales, intenciones y clústeres. Para planificación o cambios de estrategia consulta también `docs/seo/README.md`, `docs/seo/estrategia-seo.md` y `docs/seo/keywords.csv`.
