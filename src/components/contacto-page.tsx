        ...
        <section className="relative overflow-hidden bg-[linear-gradient(180deg,#FFFFFF_0%,#F8F7FF_52%,#EAEAFF_100%)] py-10 sm:py-20">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <div>
                ...
                <div className="mt-5 flex flex-col gap-2.5 sm:mt-8 sm:flex-row sm:gap-3">
                  <Link
                    ...
                    className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-[#9512A0] px-5 py-3 text-sm font-bold text-white shadow-[0_16px_38px_rgba(149,18,160,0.23)] transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#7B0C81] sm:min-h-14 sm:px-6 sm:py-4 sm:text-base sm:shadow-[0_18px_44px_rgba(149,18,160,0.26)]"
                  >
                  ...
                  <a
                    ...
                    className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-[#9512A0]/28 bg-white/85 px-5 py-3 text-sm font-bold text-[#9512A0] shadow-sm backdrop-blur transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-white sm:min-h-14 sm:px-6 sm:py-4 sm:text-base"
                  >
              ...
              <div className="rounded-[24px] border border-white/80 bg-white/84 p-4 shadow-[0_20px_60px_rgba(149,18,160,0.11)] backdrop-blur-xl sm:rounded-[30px] sm:p-6 sm:shadow-[0_26px_80px_rgba(149,18,160,0.14)]">
                <div className="rounded-[20px] border border-[#9512A0]/12 bg-[linear-gradient(135deg,#FFFFFF_0%,#F8F7FF_62%,#EAEAFF_100%)] p-4 sm:rounded-[24px] sm:p-5">
                  <div className="flex items-center gap-3">
                    <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#9512A0] text-white shadow-[0_14px_34px_rgba(149,18,160,0.18)]">
                  ...
                  <p className="mt-4 text-sm font-semibold leading-6 text-[#4A4552]">
              ...
              <div className="rounded-[24px] border border-[#D9D9FF]/80 bg-[linear-gradient(180deg,#FFFFFF_0%,#F8F7FF_100%)] p-4 shadow-[0_16px_48px_rgba(23,17,26,0.06)] sm:rounded-[30px] sm:p-8 sm:shadow-[0_22px_70px_rgba(23,17,26,0.08)]">
                ...
                <ul className="mt-4 grid gap-2.5 sm:mt-6 sm:gap-3">
                  {supportPoints.map((point) => (
                    ...
                    >
                      <Check
                        className="mt-0.5 h-4 w-4 shrink-0 text-[#9512A0]"
                        aria-hidden="true"
                      />
                      {point}
                    </li>
                ...
                <div className="mt-5 rounded-[20px] border border-[#D9D9FF]/80 bg-[#FDFDFF] p-4 sm:mt-8 sm:rounded-[24px] sm:p-5">
                  ...
                  <div className="mt-4 grid gap-3 text-sm font-semibold text-[#17111A]">
                    <a
                      ...
                      className="flex min-h-12 items-center gap-3 rounded-xl border border-[#D9D9FF]/70 bg-white px-3.5 py-3 transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#9512A0]/28 sm:rounded-2xl sm:px-4"
                    >
                      <Phone className="h-4 w-4 text-[#9512A0]" aria-hidden="true" />
                    ...
                    <a
                      ...
                      className="flex min-h-12 items-center gap-3 rounded-xl border border-[#D9D9FF]/70 bg-white px-3.5 py-3 transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#9512A0]/28 sm:rounded-2xl sm:px-4"
                    >
                      <Mail className="h-4 w-4 text-[#9512A0]" aria-hidden="true" />
                    ...
                    <div className="flex items-center gap-3 rounded-xl border border-[#D9D9FF]/70 bg-white px-3.5 py-3 sm:rounded-2xl sm:px-4">
                      <MapPin className="h-4 w-4 text-[#9512A0]" aria-hidden="true" />
            ...
            >
              ...
              <div className="mt-4 grid gap-3 sm:mt-5 sm:gap-4 md:grid-cols-3">
                {processSteps.map((step, index) => (
                  ...
                  >
                    <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#9512A0] text-sm font-black text-white shadow-[0_10px_24px_rgba(149,18,160,0.18)]">
                      {index + 1}
                    </span>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
                ...
                <a
                  href={CONTACT_INFO.whatsappHref}
                  className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-black text-[#9512A0] transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#F8F7FF]"
                >
