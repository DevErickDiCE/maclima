    ...
    <div className="min-h-screen overflow-x-hidden bg-white text-[#17111A]">
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-[linear-gradient(180deg,#FFFFFF_0%,#F8F7FF_46%,#EAEAFF_100%)] pt-8 pb-10 sm:pt-12 sm:pb-14 lg:pt-16 lg:pb-20">
          <div className="absolute inset-0 opacity-25 [background-image:linear-gradient(rgba(149,18,160,0.07)_1px,transparent_1px),linear-gradient(90deg,rgba(149,18,160,0.07)_1px,transparent_1px)] [background-size:46px_46px]" />
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-6 px-4 sm:gap-10 sm:px-6 lg:grid-cols-[1.1fr_1.3fr] lg:gap-8 lg:px-8">
            ...
            {/* Columna izquierda */}
            <motion.div {...fadeUp}>
              <span className="inline-flex items-center gap-2 rounded-full border border-[#9512A0]/25 bg-white/85 px-3.5 py-1.5 text-[10.5px] font-black uppercase tracking-[0.20em] text-[#9512A0] shadow-sm backdrop-blur">
              ...
              <p className="mt-3.5 text-[14px] leading-[1.6] text-[#4A4552] sm:mt-5 sm:text-[15px] sm:leading-[1.7]">
              ...
              <div className="mt-3 flex items-start gap-2.5 sm:mt-4">
                <span className="mt-2 h-0.5 w-6 shrink-0 rounded-full bg-[#9512A0]" />
              ...
              {/* Beneficios sutiles */}
              <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-1.5 text-[11px] font-medium text-[#4A4552] sm:mt-4 sm:gap-x-4">
                {heroBenefits.map((b) => (
              ...
              <div className="mt-4 flex flex-col gap-2.5 sm:mt-5 sm:flex-row sm:flex-wrap">
                <a
                  href="#formulario"
                  className="group inline-flex min-h-13 w-full items-center justify-center gap-2 rounded-xl bg-[#9512A0] px-5 py-3.5 text-[0.9rem] font-bold text-white shadow-[0_20px_48px_rgba(149,18,160,0.32)] ring-1 ring-[#9512A0]/40 transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#7B0C81] sm:w-auto"
                >
                ...
                <a
                  ...
                  className="group inline-flex min-h-13 w-full items-center justify-center gap-2 rounded-xl bg-white px-5 py-3.5 text-[0.9rem] font-semibold text-[#4A4552] shadow-sm ring-1 ring-[#D9D9FF] transition duration-200 ease-out hover:-translate-y-0.5 hover:text-[#9512A0] hover:ring-[#9512A0]/30 sm:w-auto"
                >
              ...
              <p className="mt-2.5 text-[11px] font-medium text-[#7A7484]">
            ...
            <motion.div {...fadeUp} className="relative pb-8 sm:pb-12 lg:pb-12">
              {/* Glow suave detrás */}
              <div className="pointer-events-none absolute -inset-x-6 -inset-y-8 -z-10 rounded-[48px] bg-[radial-gradient(ellipse_at_55%_50%,rgba(149,18,160,0.16),transparent_65%)] blur-2xl" />
              ...
              <div className="relative overflow-hidden rounded-[22px] ring-1 ring-[#D9D9FF]/50 shadow-[0_30px_84px_rgba(23,17,26,0.18)] sm:rounded-[32px] sm:shadow-[0_44px_120px_rgba(23,17,26,0.22)]">
                <Image
                  ...
                  priority
                />
                <div className="absolute inset-0 bg-[linear-gradient(160deg,rgba(149,18,160,0.10)_0%,transparent_40%,rgba(23,17,26,0.30)_100%)]" />
              ...
              <div className="absolute -bottom-2 right-2 w-[158px] rounded-[14px] border border-white/60 bg-white/82 p-3 shadow-[0_16px_40px_rgba(149,18,160,0.20)] backdrop-blur-md sm:-bottom-3 sm:right-3 sm:w-[178px] sm:p-3.5">
                <div className="flex items-center gap-2">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-[#9512A0]/12 text-[#9512A0]">
                    <Sparkles className="h-2.5 w-2.5" aria-hidden="true" />
                  </span>
                  <p className="text-[9.5px] font-black uppercase tracking-[0.14em] text-[#9512A0]">
                    Estudio previo
                  </p>
                </div>
                <p className="mt-1 text-[11px] font-medium leading-[1.5] text-[#4A4552]">
        ...
        <section className="bg-white py-10 sm:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div {...fadeUp} className="max-w-3xl">
              <p className="text-[10.5px] font-black uppercase tracking-[0.20em] text-[#9512A0]">
                Primera consulta
              </p>
              ...
              <p className="mt-3 text-sm leading-6 text-[#4A4552] sm:text-[15px] sm:leading-[1.7]">
            ...
            <div className="mt-5 grid gap-2.5 sm:mt-8 sm:grid-cols-2 sm:gap-4">
              {reviewItems.map((item) => (
                <motion.div
                  key={item.n}
                  {...fadeUp}
                  className="group flex gap-3 rounded-[18px] border border-[#D9D9FF]/80 bg-white p-4 transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#9512A0]/25 hover:shadow-[0_18px_48px_rgba(149,18,160,0.08)] sm:gap-4 sm:rounded-[20px] sm:p-5"
                >
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#F8F7FF] text-[11px] font-black tracking-wider text-[#9512A0] ring-1 ring-[#9512A0]/15 transition duration-200 group-hover:bg-[#9512A0] group-hover:text-white group-hover:ring-[#9512A0]">
                    {item.n.toString().padStart(2, "0")}
                  </span>
                  <div className="flex-1">
                    <p className="text-[15px] font-black leading-snug text-[#17111A]">{item.title}</p>
                    <p className="mt-1.5 text-[13.5px] leading-[1.6] text-[#4A4552]">{item.text}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-14">
              <motion.div {...fadeUp}>
                ...
                <div className="mt-5 flex flex-wrap gap-x-5 gap-y-2 text-[12px] font-semibold text-[#4A4552]">
                  {["Sin compromiso", "Orientación técnica", "Propuesta personalizada"].map((tag) => (
                    <span key={tag} className="inline-flex items-center gap-1.5">
                      <Check className="h-3 w-3 shrink-0 text-[#9512A0]" aria-hidden="true" />
                      {tag}
                    </span>
                  ))}
                </div>
                ...
                {processSteps.map((step, i) => (
                  <div key={step.n} className="flex gap-3.5">
                    <div className="flex flex-col items-center">
                      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#9512A0] text-[11px] font-black text-white shadow-[0_4px_12px_rgba(149,18,160,0.30)]">
                        {step.n}
                      </span>
                      {i < processSteps.length - 1 && (
                        <div className="mt-1 w-px flex-1 bg-gradient-to-b from-[#9512A0]/25 via-[#D9D9FF]/40 to-transparent" />
                      )}
                    </div>
                    <div className={`flex-1 ${i < processSteps.length - 1 ? "pb-2.5" : ""}`}>
                      <div className="rounded-[15px] border border-[#D9D9FF]/75 bg-white px-3.5 py-3 shadow-[0_4px_18px_rgba(23,17,26,0.04)] transition duration-200 hover:border-[#9512A0]/30 hover:shadow-[0_10px_28px_rgba(149,18,160,0.08)] sm:px-4">
                        <p className="text-[14.5px] font-black leading-snug text-[#17111A]">{step.title}</p>
                        <p className="mt-1 text-[13px] leading-[1.6] text-[#4A4552]">{step.text}</p>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-start lg:gap-12">
              <motion.div {...fadeUp}>
                ...
                <p className="mt-3 text-sm leading-6 text-[#4A4552] sm:mt-4 sm:text-[15px] sm:leading-[1.7]">
                ...
                <div className="mt-4 flex items-start gap-2.5">
                  <span className="mt-2 h-0.5 w-7 shrink-0 rounded-full bg-[#9512A0]" />
                  <p className="text-sm font-bold leading-6 text-[#17111A]">
                ...
                <div className="mt-4 grid gap-2 sm:mt-6">
                  <a
                    href={CONTACT_INFO.whatsappHref}
                    className="flex items-center gap-3 rounded-2xl border border-[#D9D9FF]/80 bg-white px-4 py-3 text-sm font-semibold text-[#17111A] transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#9512A0]/25 hover:shadow-sm"
                  >
                    <MessageCircle className="h-4 w-4 shrink-0 text-[#9512A0]" aria-hidden="true" />
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 rounded-2xl border border-[#D9D9FF]/80 bg-white px-4 py-3 text-sm font-semibold text-[#17111A] transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#9512A0]/25 hover:shadow-sm"
                  >
                    <Zap className="h-4 w-4 shrink-0 text-[#9512A0]" aria-hidden="true" />
                ...
                return (
                  <motion.div
                    ...
                    className={`group relative flex gap-3 rounded-[18px] border p-4 transition duration-200 ease-out hover:-translate-y-0.5 sm:gap-4 sm:rounded-[20px] sm:p-5 ${
                      featured
                        ? "border-[#9512A0]/28 bg-[linear-gradient(135deg,#FFFFFF_0%,#F8F7FF_100%)] shadow-[0_14px_44px_rgba(149,18,160,0.07)] hover:border-[#9512A0]/35 hover:shadow-[0_22px_56px_rgba(149,18,160,0.14)]"
                        : "border-[#D9D9FF]/75 bg-white hover:border-[#9512A0]/30 hover:shadow-[0_16px_42px_rgba(149,18,160,0.08)]"
                    }`}
                  >
                    <span
                      className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl transition duration-200 ${
                        featured
                          ? "bg-[#9512A0] text-white shadow-[0_8px_22px_rgba(149,18,160,0.30)] group-hover:scale-105"
                          : "border border-[#D9D9FF] bg-[#F8F7FF] text-[#9512A0] group-hover:border-[#9512A0]/30"
                      }`}
                    >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-1.5 text-[13.5px] leading-[1.6] text-[#4A4552]">{text}</p>
                    </div>
                  </motion.div>
                );
              })}
            ...
            <div className="mt-5 grid gap-2.5 sm:mt-8 sm:grid-cols-3 sm:gap-4">
              {supportAreas.map(({ icon: Icon, title, text }) => (
                <motion.div
                  key={title}
                  {...fadeUp}
                  className="group rounded-[18px] border border-[#D9D9FF]/75 bg-white p-4 shadow-[0_10px_30px_rgba(149,18,160,0.05)] transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#9512A0]/25 hover:shadow-[0_18px_48px_rgba(149,18,160,0.12)] sm:rounded-[20px] sm:p-5 sm:shadow-[0_12px_36px_rgba(149,18,160,0.05)]"
                >
                  <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#F8F7FF] text-[#9512A0] ring-1 ring-[#9512A0]/12 transition duration-200 group-hover:bg-[#9512A0] group-hover:text-white group-hover:ring-[#9512A0]">
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <motion.div {...fadeUp}>
              <div className="mb-6 max-w-3xl">
                ...
                <p className="mt-3 text-sm leading-[1.7] text-[#4A4552]">
              ...
              <div className="rounded-[20px] border border-[#D9D9FF]/75 bg-[linear-gradient(180deg,#FFFFFF_0%,#FBFAFF_100%)] p-4 shadow-[0_10px_30px_rgba(23,17,26,0.04)] sm:rounded-[24px] sm:p-7 sm:shadow-[0_12px_36px_rgba(23,17,26,0.04)]">
                <div className="flex items-center gap-3 border-b border-[#D9D9FF]/80 pb-4">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#F8F7FF] text-[#9512A0] ring-1 ring-[#9512A0]/12">
                    <ClipboardList className="h-4 w-4" aria-hidden="true" />
                  </span>
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#9512A0]">
                      Marco normativo
                    </p>
                ...
                <ul className="mt-4 grid gap-2">
                  {normas.map((norma, i) => (
                    <li
                      key={i}
                      className="grid grid-cols-[auto_1fr] items-start gap-3 rounded-xl border border-[#D9D9FF]/70 bg-white px-4 py-3 transition duration-200 hover:border-[#9512A0]/30"
                    >
                      <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-[#F8F7FF] text-[10px] font-black text-[#9512A0] ring-1 ring-[#9512A0]/15">
                        {i + 1}
                      </span>
                      <p className="text-[12.5px] font-medium leading-[1.65] text-[#4A4552]">{norma}</p>
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <section className="bg-[linear-gradient(180deg,#FFFFFF_0%,#FAF9FF_100%)] py-8 sm:py-14">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <motion.div
              {...fadeUp}
              className="rounded-[20px] border border-[#D9D9FF]/75 bg-[linear-gradient(135deg,#FFFFFF_0%,#FBFAFF_100%)] p-4 shadow-[0_12px_34px_rgba(149,18,160,0.06)] sm:rounded-[24px] sm:p-8 sm:shadow-[0_14px_44px_rgba(149,18,160,0.07)] lg:p-9"
            >
              <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-10">
                <div className="max-w-2xl">
                  <div className="flex items-center gap-2.5">
                    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#F8F7FF] text-[#9512A0] ring-1 ring-[#9512A0]/15">
                  ...
                  <p className="mt-3 text-[14px] leading-[1.7] text-[#4A4552]">
                  ...
                  <p className="mt-2 text-[13.5px] leading-[1.7] text-[#7A7484]">
                ...
                <Link
                  href="/catalogo"
                  className="group inline-flex min-h-13 w-full items-center justify-center gap-2 rounded-xl bg-[#9512A0] px-6 py-3.5 text-sm font-bold text-white shadow-[0_14px_30px_rgba(149,18,160,0.22)] transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#7B0C81] lg:w-auto lg:shrink-0"
                >
        ...
        <section className="bg-[#0F0A14] py-10 sm:py-18">
          <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="relative overflow-hidden rounded-[24px] border border-white/8 bg-[linear-gradient(135deg,#1C1320_0%,#2A1830_48%,#7B0C81_100%)] px-5 py-9 text-center shadow-[0_28px_72px_rgba(149,18,160,0.26)] sm:rounded-[36px] sm:px-12 sm:py-16 sm:shadow-[0_36px_96px_rgba(149,18,160,0.32)]">
              <div className="pointer-events-none absolute right-[-12%] top-[-30%] h-80 w-80 rounded-full bg-[#D9D9FF]/15 blur-3xl" />
              <div className="pointer-events-none absolute bottom-[-35%] left-[-10%] h-72 w-72 rounded-full bg-[#9512A0]/40 blur-3xl" />
              ...
              <div className="relative">
                ...
                <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                  <a
                    href="#formulario"
                    className="group inline-flex min-h-13 w-full items-center justify-center gap-2 rounded-xl bg-white px-6 py-3.5 text-[0.95rem] font-bold text-[#9512A0] shadow-[0_20px_44px_rgba(0,0,0,0.22)] transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#F8F7FF] sm:w-auto"
                  >
