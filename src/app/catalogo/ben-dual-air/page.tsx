      ...
      <main>
        ...
        <section className="bg-[linear-gradient(180deg,#FFFFFF_0%,#F8F7FF_52%,#EAEAFF_100%)] py-12 sm:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <Link
              href="/catalogo"
              className="inline-flex items-center gap-2 rounded-xl border border-[#9512A0]/25 bg-white px-4 py-2.5 text-sm font-bold text-[#9512A0] shadow-sm transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#F8F7FF]"
            >
              <ArrowLeft className="h-4 w-4" aria-hidden="true" />
              Volver al catálogo
            </Link>

            <article className="mt-6 overflow-hidden rounded-[34px] border border-[#D9D9FF]/80 bg-[radial-gradient(circle_at_10%_12%,rgba(217,217,255,0.8),transparent_30%),linear-gradient(135deg,#FFFFFF_0%,#F8F7FF_52%,#EAEAFF_100%)] p-5 shadow-[0_28px_88px_rgba(149,18,160,0.13)] sm:p-7 lg:p-9">
              <div className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
                ...
                <div className="relative min-h-[300px] overflow-hidden rounded-[28px] border border-white/80 bg-[#17111A] shadow-[0_28px_84px_rgba(23,17,26,0.18)] sm:min-h-[420px] lg:min-h-[440px]">
                  ...
                  <span className="absolute left-5 top-5 rounded-full border border-white/25 bg-white/90 px-3 py-2 text-xs font-black uppercase tracking-[0.14em] text-[#9512A0] shadow-sm backdrop-blur">
                ...
                <div>
                  ...
                  <p className="mt-4 text-base leading-7 text-[#4A4552]">
                  ...
                  <div className="mt-5 grid grid-cols-1 gap-2 sm:grid-cols-3">
                    {heroBenefits.map((b) => (
                      ...
                      >
                        <span className="mx-auto mb-2 flex h-7 w-7 items-center justify-center rounded-full bg-[#EAEAFF] text-[#9512A0]">
                          <Check className="h-3.5 w-3.5" aria-hidden="true" />
                        </span>
                        <p className="text-xs font-bold leading-snug text-[#17111A]">
                          {b.label}
                          {"note" in b && b.note ? (
                            <span className="ml-0.5 text-[9px] font-semibold text-[#7A7484]">*</span>
                          ) : null}
                        </p>
                        <p className="mt-1 text-[11px] font-medium leading-4 text-[#4A4552]">
                          {b.desc}
                        </p>
                      </div>
                    ))}
                  </div>
                  <p className="mt-2 text-[11px] font-semibold text-[#7A7484]">
                  ...
                  <div className="mt-6">
                    <Link
                      href="/contacto"
                      className="group inline-flex min-h-14 w-full items-center justify-center gap-2 rounded-xl bg-[#9512A0] px-6 py-4 text-base font-bold text-white shadow-[0_18px_44px_rgba(149,18,160,0.24)] transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#7B0C81] sm:w-auto"
                    >
        ...
        <section className="bg-white py-14 sm:py-18">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-[1.4fr_1fr] lg:grid-cols-[1.4fr_1fr_1fr]">
              ...
              <div className="relative min-h-[200px] overflow-hidden rounded-[28px] border border-[#D9D9FF]/70 bg-[#EAEAFF] shadow-[0_22px_64px_rgba(149,18,160,0.10)] sm:min-h-0 lg:min-h-[340px]">
                <Image
        ...
        <section className="bg-[linear-gradient(180deg,#F8F7FF_0%,#EAEAFF_100%)] py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 text-lg leading-8 text-[#4A4552]">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {differentials.map(({ icon: Icon, title, text }) => (
                <div
                  key={title}
                  className="rounded-[28px] border border-white/80 bg-white p-6 shadow-[0_22px_70px_rgba(149,18,160,0.08)] sm:p-7"
                >
                  <span className="flex h-14 w-14 items-center justify-center rounded-2xl border border-[#D9D9FF] bg-[#EAEAFF] text-[#9512A0] shadow-sm">
                    <Icon className="h-7 w-7" aria-hidden="true" />
                  </span>
                  <h3 className="mt-5 text-xl font-black text-[#17111A]">{title}</h3>
                  <p className="mt-2 text-base leading-7 text-[#4A4552]">{text}</p>
                </div>
              ))}
            </div>

            <p className="mt-7 text-center text-sm font-semibold text-[#7A7484]">
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              ...
              <div className="flex flex-wrap gap-3">
                {idealFor.map((item) => (
                  ...
                  >
                    <Check className="h-4 w-4 text-[#9512A0]" aria-hidden="true" />
                    {item}
                  </span>
                ))}
              </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-[1fr_0.6fr] lg:items-start">
              <div>
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-2">
                  {functions.map(({ icon: Icon, title, text }) => (
                    <div
                      key={title}
                      className="flex items-start gap-4 rounded-[22px] border border-[#D9D9FF]/70 bg-white p-4 shadow-[0_14px_38px_rgba(149,18,160,0.07)]"
                    >
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs leading-5 text-[#4A4552]">{text}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="relative min-h-[280px] overflow-hidden rounded-[28px] border border-[#D9D9FF]/70 bg-[#EAEAFF] shadow-[0_22px_64px_rgba(149,18,160,0.12)] sm:min-h-[340px]">
                  <Image
                    src="/imagen/BEN-Dual-AIR/ben-stat-4-png.webp"
                    alt="Termostato BEN Stat para control del sistema de aerotermia"
                    fill
                ...
                <div className="rounded-[22px] border border-[#D9D9FF]/80 bg-white px-5 py-4 text-sm font-semibold leading-6 text-[#4A4552] shadow-sm">
                  <span className="font-black text-[#9512A0]">BEN Stat:</span>{" "}
            ...
            <div className="mx-auto mt-10 max-w-3xl">
              <ol className="grid gap-3">
                {installationSteps.map((step, i) => (
                  ...
                  >
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#9512A0] text-sm font-black text-white shadow-[0_8px_18px_rgba(149,18,160,0.18)]">
                      {i + 1}
                    </span>
              ...
              <div className="mt-5 flex items-start gap-3 rounded-[20px] border border-[#D9D9FF] bg-white px-5 py-4 text-sm font-semibold leading-6 text-[#4A4552] shadow-sm">
                <Zap className="mt-0.5 h-4 w-4 shrink-0 text-[#9512A0]" aria-hidden="true" />
        ...
        {/* ── CTA final ───────────────────────────────────────────── */}
        <section className="bg-[linear-gradient(135deg,#17111A_0%,#2A1830_62%,#9512A0_100%)] py-18 sm:py-22">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <div className="relative overflow-hidden rounded-[32px] border border-white/20 bg-white/[0.08] px-6 py-12 shadow-[0_28px_80px_rgba(23,17,26,0.20)] backdrop-blur-xl sm:px-10">
              ...
              <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                <Link
                  href="/contacto"
                  className="group inline-flex min-h-14 items-center justify-center gap-2 rounded-xl bg-white px-6 py-4 text-base font-bold text-[#9512A0] shadow-[0_18px_44px_rgba(23,17,26,0.18)] transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#F8F7FF]"
                >
