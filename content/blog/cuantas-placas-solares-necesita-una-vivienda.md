...
cluster: "Fotovoltaica"
keyword_principal: "cuántas placas solares necesito"
intencion: "informacional"
zona: "España"
pagina_pilar: "/fotovoltaica"
status: "publicado"
image: "/blog/cuantas-placas-solares-necesita-una-vivienda.webp"
imageAlt: "Vivienda unifamiliar con paneles fotovoltaicos y símbolos de consumo, recorrido solar y sombras"
---
...
El [IDAE explica en su guía para convertirse en autoconsumidor](https://idae.es/sites/default/files/NIPO-629-24-002-4_GUIA_05_PASOS-CONVERTIRSE-EN-AUTOCONSUMIDOR%20actualizado.pdf) que el patrón de consumo influye en el ahorro y que un estudio de viabilidad puede requerir los datos de las facturas eléctricas. La misma guía señala que el espacio disponible, la zona y la orientación respecto al sol son factores esenciales.
...
La herramienta [“Entiende tu factura” de la CNMC](https://www.cnmc.es/prensa/entiende-tu-factura-20231002) permite consultar consumos de energía y otros datos del suministro. No hay que confundirlos:
...
La producción de la instalación depende del recurso solar local y de cómo se colocan los módulos. Para una estimación pública se puede utilizar [PVGIS, la herramienta fotovoltaica del Centro Común de Investigación de la Comisión Europea](https://joint-research-centre.ec.europa.eu/photovoltaic-geographical-information-system-pvgis/using-pvgis-5/pvgis-5-tools/grid-connected-pv_en).
...
En Maclima podemos estudiar una [instalación fotovoltaica](/fotovoltaica) y comparar escenarios de potencia y producción según la vivienda. También puedes consultar el [catálogo de soluciones fotovoltaicas](/catalogo#fotovoltaica-catalogo) o conocer un ejemplo de nuestro trabajo de divulgación sobre [energía y autoconsumo en la Sierra de Madrid](/blog/maclima-comunidad-energetica-el-boalo-cerceda-mataelpino).

Si quieres convertir tus facturas y las condiciones de tu cubierta en una propuesta técnica, solicita una [consultoría fotovoltaica gratuita](/consultoria-gratuita?tipo=Fotovoltaica#formulario).
...
**¿Quieres saber qué instalación fotovoltaica encaja mejor en tu vivienda? Contacta con Maclima Soluciones Energéticas y te asesoramos sin compromiso.**
